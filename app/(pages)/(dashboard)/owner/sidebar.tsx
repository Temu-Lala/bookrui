...
const iconMap = {
  ...
  "Books Upload": <CloudUploadIcon sx={{ color: "white" }} />,
  "Book Previews": <PreviewIcon sx={{ color: "white" }} />,
  Drafts: <DraftsIcon sx={{ color: "white" }} />,
};

const items = ["Dashboard", "Books Upload", "Book Previews", "Drafts"];
...
export default function PersistentDrawerLeft() {
  ...
  const renderSelectedComponent = () => {
    switch (selectedComponent) {
      ...
      case "booksupload":
        return <DynamicBooksUpload />;
      case "bookpreviews":
        return <DynamicBookPreviews />;
      case "drafts":
...
const DynamicBooksUpload = dynamic(() => import("./booksupload"), {
  ssr: false,
});
const DynamicBookPreviews = dynamic(() => import("./tables"), {
  ssr: false,
});
const DynamicDrafts = dynamic(() => import("./dashboard"), {
  ssr: false,
});
